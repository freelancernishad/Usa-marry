...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(AuthenticateAdmin::class)->group(function () {
            ...
            Route::prefix('/users')->group(function () {
                    ...
                    Route::get('/login-report/logged-in', [\App\Http\Controllers\Api\Admin\Users\LoginReportController::class , 'loggedInUsers']);
                    Route::get('/login-report/not-logged-in', [\App\Http\Controllers\Api\Admin\Users\LoginReportController::class , 'notLoggedInUsers']);
